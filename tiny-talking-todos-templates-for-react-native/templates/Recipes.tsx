...
const RecipeList = ({ listId = "default-recipe-list" }) => {
  ...
  const bgGradient = useColorModeValue(
    "linear-gradient(180deg, #EBF8FF 0%, white 100%)",
      ...
      <VStack spacing={5} align="stretch" p={5}>
        <HStack justify="space-between" alignItems="flex-start">
          ...
          <HStack spacing={2}>
            ...
            <Button leftIcon={<Plus />} colorScheme="blue" onClick={onOpen} size="sm" borderRadius="md">
              Add
            </Button>
          </HStack>
        </HStack>
        ...
        <VStack spacing={3} align="stretch">
          ...
          {todoIds.length === 0 && (
            <VStack py={8} spacing={3}>
              ...
              <Text textAlign="center" color={headerColor} fontWeight="medium" fontSize="lg">No recipes yet</Text>
              <Text textAlign="center" color={subTextColor} fontSize="sm" maxW="280px">Start by adding your favorite recipe to build your collection</Text>
            </VStack>
          )}
        </VStack>
      </VStack>

      <AddRecipeModal isOpen={isOpen} onClose={onClose} onAdd={(recipe) => { addRecipe(recipe); playAdd(); }} />
    </Box>
  );
};
